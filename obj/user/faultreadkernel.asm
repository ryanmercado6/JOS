	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800238:	0f be 84 03 65 ee ff 	movsbl -0x119b(%ebx,%eax,1),%eax
  80023f:	ff 
  800240:	50                   	push   %eax
...
00800288 <vprintfmt>:
{
  ...
  800314:	03 b4 81 f4 ee ff ff 	add    -0x110c(%ecx,%eax,4),%esi
...
008003d7 <.L28>:
  ...
  8003fc:	8d 80 86 ee ff ff    	lea    -0x117a(%eax),%eax
  800402:	50                   	push   %eax
  800403:	57                   	push   %edi
  800404:	56                   	push   %esi
  ...
  800419:	8d 80 7d ee ff ff    	lea    -0x1183(%eax),%eax
  80041f:	50                   	push   %eax
  800420:	57                   	push   %edi
  800421:	56                   	push   %esi
...
00800432 <.L24>:
  ...
  800448:	8d 80 76 ee ff ff    	lea    -0x118a(%eax),%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800b6d:	8d 83 4c f0 ff ff    	lea    -0xfb4(%ebx),%eax
  800b73:	50                   	push   %eax
  800b74:	6a 23                	push   $0x23
  800b76:	8d 83 69 f0 ff ff    	lea    -0xf97(%ebx),%eax
  800b7c:	50                   	push   %eax
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800bce:	57                   	push   %edi
  800bcf:	50                   	push   %eax
  800bd0:	8d 83 78 f0 ff ff    	lea    -0xf88(%ebx),%eax
  800bd6:	50                   	push   %eax
  ...
  800be3:	e8 32 f5 ff ff       	call   80011a <vcprintf>
	cprintf("\n");
  800be8:	8d 83 9b f0 ff ff    	lea    -0xf65(%ebx),%eax
